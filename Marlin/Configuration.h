...
#define STRING_CONFIG_H_AUTHOR "(Thief)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "eBay special 2.0"
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 100, 100, 5, 4 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0.50, -47.00, -2.00 }
